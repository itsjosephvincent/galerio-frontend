<template>
    <NuxtLayout name="cms">
        ...
        <Head>
            <Title>CMS - New Certificate | {{ runtimeConfig.appName }}</Title>
        </Head>
        ...
        <div>
            ...
            <div class="py-4">
                <h3 class="text-2xl text-gray-500">New Certificate</h3>
            </div>
...
async function saveCertificate() {
    ...
    if (!v$.value.$error) {
        ...
        try {
            ...
            const response = await certificateService.saveCertificate(params)
            if (response.data) {
                successAlert('Success!', t('saveCertificateData'))
